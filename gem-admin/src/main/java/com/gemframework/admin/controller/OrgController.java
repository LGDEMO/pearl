...
import com.gemframework.admin.service.OrgService;
...
public class OrgController {
     ...
     */
    @PostMapping("add")
    public BaseResult add(@Valid @RequestBody OrgVo vo, BindingResult bindingResult){
     ...
     */
    @PostMapping("update")
    public BaseResult update(OrgVo vo){
        return BaseResult.SUCCESS(orgService.update(vo));
    }
    ...
    public BaseResult list(){
        List list = orgService.findListAll();
    ...
    public BaseResult listByParams(OrgVo vo){
        List<OrgVo> list = orgService.findListByParams(vo);
        return BaseResult.SUCCESS(list);
    }
    ...
    public BaseResult page(Pageable pageable){
        List<OrgVo> vo = orgService.findPageAll(pageable);
    ...
    public BaseResult pageByParams(OrgVo vo,Pageable pageable){
        List<OrgVo> list =  orgService.findPageByParams(vo,pageable);
        return BaseResult.SUCCESS(list);
    }
